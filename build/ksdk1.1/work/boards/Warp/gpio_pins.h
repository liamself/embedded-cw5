...
enum _gpio_pins 
{
	...
	kWarpPinSPI_MOSI			= GPIO_MAKE_PIN(HW_GPIOA, 8),		/*	Warp KL03_SPI_MOSI	--> PTA7									*/
	kWarpPinI2C0_SCL			= GPIO_MAKE_PIN(HW_GPIOB, 0),		/*	Warp KL03_I2C0_SCL	--> PTB3									*/
	kWarpPinI2C0_SDA			= GPIO_MAKE_PIN(HW_GPIOB, 1)		/*	Warp KL03_I2C0_SDA	--> PTB4									*/
