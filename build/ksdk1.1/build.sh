#!/bin/sh
	...
	cp ../../src/boot/ksdk1.1.0/devSI1145.*						work/demos/Warp/src/
	cp ../../src/boot/ksdk1.1.0/devSTEMMA.*						work/demos/Warp/src/
	cp ../../src/boot/ksdk1.1.0/devAHT20.*						work/demos/Warp/src/
